...
def main(attr_map: int = 0, 
    ...
    segments = None
    if seg_map == 0:
        segments = slic(img_np, n_segments=50, compactness=1, start_label=1)
    ...
    torch.save(working_example, 'labelme/MNIST_94/metric_results_slic_gradcam/' + img_name)
    ...
    img_dir = os.path.join(img_dir, 'results_slic_gradcam', img_name)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--img_dir', default='/workspace/adv_robustness' + 
                        '/region_explainability/' + 'labelme/MNIST_94/test_images',
