...
def main(attr_map: int = 0, 
    ...
    torch.save(working_example, 'labelme/MNIST_pullover_shirt/metric_results_felzen_gradcam/' + img_name)
    ...
    img_dir = os.path.join(img_dir, 'results_felzen_gradcam', img_name)
