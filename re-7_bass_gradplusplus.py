...
def main(attr_map: int = 0, 
    ...
    if seg_map == 1:
        segments = csv_mask_to_numpy('labelme/MNIST_71/BASS_output/' + img_name[:-3] +'csv')
    ...
    torch.save(working_example, 'labelme/MNIST_71/metric_results_bass_gradcamplusplus/' + img_name)
